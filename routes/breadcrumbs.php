...
//Home > Thông tin dụng cụ
Breadcrumbs::for('equipment', function ($trail) {
    $trail->parent('home');
    $trail->push('Thông tin dụng cụ', route('admin.equipment'));
});
...
Breadcrumbs::for('customer', function ($trail) {
    $trail->parent('home');
    $trail->push('Thông tin khách hàng', route('admin.customer'));
});


//Home > Thông tin nhân viên
Breadcrumbs::for('employe', function ($trail) {
    $trail->parent('home');
    $trail->push('Thông tin nhân viên', route('admin.employe'));
});

//Home > Thông tin chủ sân
Breadcrumbs::for('owner', function ($trail) {
    $trail->parent('home');
    $trail->push('Thông tin chủ sân', route('admin.owner'));
});
