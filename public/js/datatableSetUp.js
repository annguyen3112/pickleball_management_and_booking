...
$(document).ready(function () {
    ...
    //     ajax: BASE_URL_API.getEquipment,
    //     columns: [
    //         {
    //             data: "id",
    //         },
    ...
    //             data: "id",
    //             render: function (data, type, row) {
    //                 const btn_edit = `<button data-id="${data}" class="btn-edit-equipment btn btn-warning"><i class="bi bi-pencil-fill"></i></button>`;
    //                 return btn_edit;
    //             },
    //             orderable: false,
    //         },
    ...
    //             render: function (data, type, row) {
    //                 if (ROLE != 2) return "";
    //                 const btn_delete = `<button data-id="${data}" class="btn-delete-equipment btn btn-danger"><i class="bi bi-trash-fill"></i></button>`;
    //                 return btn_delete;
    //             },
    //             orderable: false,
    //         },
            ...
            },
            {
                ...
                render: function (data, type, row) {
                    switch (data) {
                        ...
                        case 2:
                            return `<div class="text-running">Đã được đặt</div>`;
                        case 3:
        ...
        columns: [
            ...
            },
            {
                ...
                render: function (data, type, row) {
                    ...
                    const btn = `<img width=70 src="${URL_IMAGE + data
                        }" alt="photo">`;
                    console.log("Final Image URL:", URL_IMAGE + data);
