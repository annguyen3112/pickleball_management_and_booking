            ...
            <form action="{{ route('footballPitch.store') }}" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="row mb-3">
                        <label for="inputEmail" class="col-sm-6 col-form-label">
                            ...
                            <select name="time_start" class="form-select" aria-label="Default select example">
                                <option value="1:00:00" selected>5:00:00</option>
                                <script>
                                    for (i = 2; i <= 24; i++) {
                        ...
                        <label for="inputEmail" class="col-sm-6 col-form-label">
                            ...
                            <select name="time_end" class="form-select" aria-label="Default select example">
                                <option value="1:00:00" selected>24:00:00</option>
                                <script>
                                    for (i = 2; i <= 24; i++) {
                                        document.write('<option value="' + i + ':00:00">' + i + ':00:00</option>');
                                    }
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-8">
                            <input required value="100000" type="number" name="price_per_hour"
                                class="form-control">
                        </div>
                    </div>
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-8">
                            <input required value="120000" type="number" name="price_per_peak_hour"
                                class="form-control">
                        </div>
                    </div>
                    <div class="row mb-3">
