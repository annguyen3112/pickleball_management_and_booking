{{-- Modal --}}
<div class="modal fade" id="add-customer-modal" tabindex="-1" style="display: none;"
aria-hidden="true">
<div class="modal-dialog modal-lg">
    <div class="modal-content">
        <form action="{{ route('user.storeCustomer') }}" method="POST">
            @csrf
            <div class="modal-header bg-success text-light">
                <h5 class="modal-title text-light">Thêm khách hàng mới</h5>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn-add-customer btn btn-success">Thêm</button>
            </div>
        </form>
    </div>
</div>
