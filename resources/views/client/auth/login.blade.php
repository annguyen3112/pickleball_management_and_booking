                        ...
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('client.processLogin') }}">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input value="{{ session()->get('email') }}" name="email" type="email" placeholder="Nhập địa chỉ email của bạn" class="form-control">
                                </div>
                                <div class="form-group mb-3">
                                    <label class="form-label">Mật khẩu <span class="text-danger">*</span></label>
                                    <div class="input-group mb-3">
                                        <input value="{{ session()->get('password') }}" id="password" name="password" type="password" placeholder="Nhập mật khẩu" class="form-control">
