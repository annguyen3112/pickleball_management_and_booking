                        ...
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('client.processRegister') }}">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input value="{{ old('name') }}" name="name" type="text" placeholder="Nhập họ và tên" class="form-control">
                                </div>
                                <div class="form-group mb-3">
                                    <label class="form-label">Số điện thoại <span class="text-danger">*</span></label>
                                    <input value="{{ old('phone') }}" name="phone" type="number" placeholder="Nhập số điện thoại" class="form-control">
                                </div>
                                <div class="form-group mb-3">
                                    <label class="form-label">Địa chỉ email <span class="text-danger">*</span></label>
                                    <input value="{{ old('email') }}" name="email" type="email" placeholder="Nhập địa chỉ email" class="form-control">
                                </div>
                                <div class="form-group mb-3">
