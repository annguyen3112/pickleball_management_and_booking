                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <div class="input-group mb-3">
                            <input type="text" class="form-control" id="code" placeholder="Nhập mã code đặt sân của bạn" value="{{ $code ?? '' }}">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-6">
                        <div class="alert alert-danger text-center">
                            Mã đặt sân không hợp lệ. Vui lòng kiểm tra lại!
                        </div>
                    </div>
                </div>
            @endif
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $order->footballPitch->name }} <span class="text-secondary">|
                                                    {{ $order->footballPitch->pitchType->description }} </span></td>
                                        </tr>
                                        <tr>
                                            <td>Mã đặt sân :</td>
                                            <td>{{ $order->code }}</td>
